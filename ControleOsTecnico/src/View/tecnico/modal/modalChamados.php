        ...
        <div class="modal-content bg-success">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-outline-dark" id="btn_acao" onclick="AtenderChamado()">Iniciar</button>
                    <button type="button" class="btn btn-outline-dark" id="btn_finalizar" onclick="FinalizarChamado('tecAtendimento')">Finalizar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
