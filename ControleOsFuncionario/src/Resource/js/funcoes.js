...
function BASE_URL_API() {
    return "http://localhost/ControleOS/ControleOsAdm/src/Resource/api/funcionario_api.php";
}
...
function BASE_URL_INTRANET() {
    //return "http://localhost/ParaleloOs/ControleOsFuncionario/src/View/";
    return "http://localhost/ControleOS/ControleOsFuncionario/src/View/";
}
